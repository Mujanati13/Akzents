import { ApplicationConfig, enableProdMode, importProvidersFrom, provideZoneChangeDetection, inject, provideAppInitializer, isDevMode, LOCALE_ID } from '@angular/core';
        ...
        return firstValueFrom(initService.loadInitialAppData())
          .then((data) => {
            if (data && data.user) {
              ...
              console.log(`App initializer found role: ${roleName}`);
