...
export class NavigationService {
  ...
  private initializeMenu(): void {
    combineLatest([this.clientService.getClients(), this.clientService.getSelectedClient(), this.notificationCountSubject]).subscribe(([clients, selectedClient, notificationCount]) => {
